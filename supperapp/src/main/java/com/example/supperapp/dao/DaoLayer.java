...
public class DaoLayer {
	...
	public HashMap<String, Object> insertDocumentVerify(HashMap<String, Object> map) {	
		...
		try {
			...
			StoredProcedureQuery query= emanager.createStoredProcedureQuery("InsertDocumentValidateStatus")
					...
					.setParameter("Address",(String) map.get("Address"))
					.setParameter("City",(String) map.get("City"))
	...
	try {
		StoredProcedureQuery query= emanager.createStoredProcedureQuery("InsertSmsEmailOtp")
				...
				.setParameter("Email",(String) map.get("Email"))
				.setParameter("Mobile",(String) map.get("Mobile"))
				.setParameter("OTP",(String) map.get("OTP"))
				.setParameter("Type",(String) map.get("Type"));
	...
	public HashMap<String, Object> selfie(HashMap<String, Object> map) {	
		...
		try {
			StoredProcedureQuery query= emanager.createStoredProcedureQuery("InsertExchangeSelectionDetail")
					...
					.setParameter("CustGuId", map.get("CustGuId"))
					.setParameter("SelfiImage", map.get("SelfiImage"))
					.setParameter("IsMatch", map.get("IsMatch"))
					.setParameter("MatchScore", map.get("MatchScore"))
	...
	public HashMap<String, Object> insertBMIData(HashMap<String, Object> map) {	
		...
		try {
			StoredProcedureQuery query= emanager.createStoredProcedureQuery("InsertBmiData")
					...
					.setParameter("Height", map.get("Height"))
					.setParameter("Weight", map.get("Weight"))
					.setParameter("Age", map.get("Age"))
					.setParameter("Bmi_Report",  map.get("Bmi_Report"))
					.setParameter("Bmi_Category", map.get("Bmi_Category"))
					.setParameter("Health_Score", map.get("Health_Score"))
